...
import com.sergio.example.owngcm.utils.MenssageUtils;
...
public class MyGcmListenerService extends GcmListenerService {
    ...
    public void onMessageReceived(String from, Bundle data) {
        ...
        String composeMessage = MenssageUtils.getComposeMessage(data);

        mLogger = new LoggingService.Logger(this);
        mLogger.log(Log.INFO, composeMessage );
        /**
         ...
         */
        sendNotification(composeMessage);
    }
    // [END receive_message]
