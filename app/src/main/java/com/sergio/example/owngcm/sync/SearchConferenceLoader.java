...
/**
 * Created by syp on 16/08/15.
 */
public class SearchConferenceLoader extends AsyncTaskLoader<List<DecoratedConference>> {
    ...
    public SearchConferenceLoader(Context context) {
        super(context);
        mContext = context;
    }
    ...
    public List<DecoratedConference> loadInBackground() {
        try {
            ...
            // TODO: En un futuro cambiar getConference(filter)
            return ConferenceUtils.getConferences(null);
        } catch (IOException e) {
