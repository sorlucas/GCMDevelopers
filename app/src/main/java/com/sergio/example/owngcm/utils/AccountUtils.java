...
import static com.sergio.example.owngcm.utils.LogUtils.LOGI;
import static com.sergio.example.owngcm.utils.LogUtils.LOGV;
import static com.sergio.example.owngcm.utils.LogUtils.LOGW;
...
public class AccountUtils {
    ...
    private static final String PREFIX_PREF_PLUS_PROFILE_ID = "plus_profile_id";
    private static final String PREFIX_PREF_PLUS_NAME = "plus_name";
    private static final String PREFIX_PREF_PLUS_IMAGE_URL = "plus_image_url";
    private static final String PREFIX_PREF_PLUS_COVER_URL = "plus_cover_url";
    private static final String PREFIX_PREF_GCM_KEY = "gcm_key";
    ...
    public static String getAuthToken(final Context context) {
        ...
        return hasActiveAccount(context) ?
                sp.getString(PREFIX_PREF_AUTH_TOKEN, null) : null;
    }
    ...
    public static void setAuthToken(final Context context, final String accountName, final String authToken) {
        LOGI(TAG, "Auth token of length "
                ...
                + accountName);
        SharedPreferences sp = getSharedPreferences(context);
        sp.edit().putString(PREFIX_PREF_AUTH_TOKEN, authToken).commit();
    ...
    public static void setPlusProfileId(final Context context, final String accountName, final String profileId) {
        SharedPreferences sp = getSharedPreferences(context);
        sp.edit().putString(PREFIX_PREF_PLUS_PROFILE_ID, profileId).commit();
    }

    public static String getPlusProfileId(final Context context) {
        SharedPreferences sp = getSharedPreferences(context);
        return hasActiveAccount(context) ? sp.getString(PREFIX_PREF_PLUS_PROFILE_ID, null) : null;
    }

    public static boolean hasPlusInfo(final Context context, final String accountName) {
        SharedPreferences sp = getSharedPreferences(context);
        return !TextUtils.isEmpty(sp.getString(PREFIX_PREF_PLUS_PROFILE_ID, null));
    }

    public static boolean hasToken(final Context context, final String accountName) {
        SharedPreferences sp = getSharedPreferences(context);
        return !TextUtils.isEmpty(sp.getString(PREFIX_PREF_AUTH_TOKEN, null));
    }

    public static void setPlusName(final Context context, final String accountName, final String name) {
        SharedPreferences sp = getSharedPreferences(context);
        sp.edit().putString(PREFIX_PREF_PLUS_NAME, name).commit();
    }

    public static String getPlusName(final Context context) {
        SharedPreferences sp = getSharedPreferences(context);
        return hasActiveAccount(context) ? sp.getString(PREFIX_PREF_PLUS_NAME, "Anonim@") : null;
    }

    public static void setPlusImageUrl(final Context context, final String accountName, final String imageUrl) {
        SharedPreferences sp = getSharedPreferences(context);
        sp.edit().putString(PREFIX_PREF_PLUS_IMAGE_URL, imageUrl).commit();
    }

    public static String getPlusImageUrl(final Context context) {
        SharedPreferences sp = getSharedPreferences(context);
        return hasActiveAccount(context) ? sp.getString(PREFIX_PREF_PLUS_IMAGE_URL, null) : null;
    }
    ...
    */
    ...
    public static void setPlusCoverUrl(final Context context, final String accountName, String coverPhotoUrl) {
        SharedPreferences sp = getSharedPreferences(context);
        sp.edit().putString(PREFIX_PREF_PLUS_COVER_URL, coverPhotoUrl).commit();
    }

    public static String getPlusCoverUrl(final Context context) {
        SharedPreferences sp = getSharedPreferences(context);
        return hasActiveAccount(context) ? sp.getString(PREFIX_PREF_PLUS_COVER_URL, null) : null;
    }
    ...
    public static void setGcmKey(final Context context, final String accountName, final String gcmKey) {
        SharedPreferences sp = getSharedPreferences(context);
        sp.edit().putString(PREFIX_PREF_GCM_KEY, gcmKey).commit();
    ...
    public static String getGcmKey(final Context context, final String accountName) {
        SharedPreferences sp = getSharedPreferences(context);
        String gcmKey = sp.getString(PREFIX_PREF_GCM_KEY, null);
